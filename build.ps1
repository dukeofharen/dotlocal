...
$releaseBinDir = Join-Path -Path $PSScriptRoot "Ducode.Local\bin\Release"
$solutionDir = Join-Path -Path $PSScriptRoot "Ducode.Local"
...
# Build solution
& msbuild Ducode.Local.sln /p:Configuration=Release

# Run unit tests
& vstest.console $unitTestLocation
...
Rename-Item (Join-Path -Path $buildOutputBinDir "Ducode.Local.exe") "dotlocal.exe"
