...
!define APPNAME "DotLocal"
!define COMPANYNAME "Ducode"
!define DESCRIPTION "A simple local web server written for the .NET framework."
...
section "install"
    ...
    createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\dotlocal.exe"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${COMPANYNAME} ${APPNAME}" "DisplayIcon" "$INSTDIR\dotlocal.exe"
